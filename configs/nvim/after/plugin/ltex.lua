...
local Dictionary_file = {
    ["de-DE"] = {vim.fn.getenv("XDG_CONFIG_HOME") .. "spell/dictionary.txt"} -- there is another way to find ~/.config/nvim ?
}
local DisabledRules_file = {
    ["de-DE"] = {vim.fn.getenv("XDG_CONFIG_HOME") .. "spell/disable.txt"} -- there is another way to find ~/.config/nvim ?
}
        ...
        default_config = {
            ...
            settings = {
                ltex = {
                    ...
                    -- },
                    dictionary = {
                        ["de-DE"] = readFiles(Dictionary_file["de-DE"] or {}),
                    };
                    disabledRules = {
                        ["de-DE"] = readFiles(DisabledRules_file["de-DE"] or {}),
                    };
                    hiddenFalsePositives = {
                        ["de-DE"] = readFiles(FalsePositives_file["de-DE"] or {}),
                    };
                },
            };
        };
