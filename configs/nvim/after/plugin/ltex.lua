...
local Dictionary_file = {
	["pt-BR"] = { "~/.config/nvim/spell/dictionary.txt" }, -- there is another way to find ~/.config/nvim ?
	["de-DE"] = { "~/.config/nvim/spell/dictionary.txt" }, -- there is another way to find ~/.config/nvim ?
}
local DisabledRules_file = {
	["pt-BR"] = { "~/.config/nvim/spell/disable.txt" }, -- there is another way to find ~/.config/nvim ?
	["de-DE"] = { "~/.config/nvim/spell/disable.txt" }, -- there is another way to find ~/.config/nvim ?
}
local FalsePositives_file = {
	["pt-BR"] = { "~/.config/nvim/spell/false.txt" }, -- there is another way to find ~/.config/nvim ?
	["de-DE"] = { "~/.config/nvim/spell/false.txt" }, -- there is another way to find ~/.config/nvim ?
}
