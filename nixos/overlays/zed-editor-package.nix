...
, vulkan-loader, envsubst, gitUpdater, cargo-about, versionCheckHook, zed-editor
, buildFHSEnv, cargo-bundle, git, apple-sdk_15, darwinMinVersionHook
, makeWrapper, nodejs, libGL, libX11, libXext, livekit-libwebrtc, testers
, writableTmpDirAsHomeHook,

withGLES ? false, buildRemoteServer ? true, }:
